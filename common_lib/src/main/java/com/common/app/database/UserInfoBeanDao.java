...
public class UserInfoBeanDao extends AbstractDao<UserInfoBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property FirstLoginFlag = new Property(16, boolean.class, "firstLoginFlag", false, "FIRST_LOGIN_FLAG");
        public final static Property InvitationCode = new Property(17, String.class, "invitationCode", false, "INVITATION_CODE");
        public final static Property ZhifubaoNum = new Property(18, String.class, "zhifubaoNum", false, "ZHIFUBAO_NUM");
        public final static Property WxName = new Property(19, String.class, "wxName", false, "WX_NAME");
        public final static Property WxPhoto = new Property(20, String.class, "wxPhoto", false, "WX_PHOTO");
        public final static Property WxOpenId = new Property(21, String.class, "wxOpenId", false, "WX_OPEN_ID");
        public final static Property MsgState = new Property(22, boolean.class, "msgState", false, "MSG_STATE");
        public final static Property MsgSize = new Property(23, String.class, "msgSize", false, "MSG_SIZE");
        public final static Property AgencyLevel = new Property(24, int.class, "agencyLevel", false, "AGENCY_LEVEL");
        public final static Property ImageShare = new Property(25, String.class, "imageShare", false, "IMAGE_SHARE");
    }

    private final StringConverter imageShareConverter = new StringConverter();
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_INFO_BEAN\" (" + //
                ...
                "\"FIRST_LOGIN_FLAG\" INTEGER NOT NULL ," + // 16: firstLoginFlag
                "\"INVITATION_CODE\" TEXT," + // 17: invitationCode
                "\"ZHIFUBAO_NUM\" TEXT," + // 18: zhifubaoNum
                "\"WX_NAME\" TEXT," + // 19: wxName
                "\"WX_PHOTO\" TEXT," + // 20: wxPhoto
                "\"WX_OPEN_ID\" TEXT," + // 21: wxOpenId
                "\"MSG_STATE\" INTEGER NOT NULL ," + // 22: msgState
                "\"MSG_SIZE\" TEXT," + // 23: msgSize
                "\"AGENCY_LEVEL\" INTEGER NOT NULL ," + // 24: agencyLevel
                "\"IMAGE_SHARE\" TEXT);"); // 25: imageShare
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, UserInfoBean entity) {
        ...
        stmt.bindLong(17, entity.getFirstLoginFlag() ? 1L: 0L);
 
        String invitationCode = entity.getInvitationCode();
        if (invitationCode != null) {
            stmt.bindString(18, invitationCode);
        }
 
        String zhifubaoNum = entity.getZhifubaoNum();
        if (zhifubaoNum != null) {
            stmt.bindString(19, zhifubaoNum);
        }
 
        String wxName = entity.getWxName();
        if (wxName != null) {
            stmt.bindString(20, wxName);
        }
 
        String wxPhoto = entity.getWxPhoto();
        if (wxPhoto != null) {
            stmt.bindString(21, wxPhoto);
        }
 
        String wxOpenId = entity.getWxOpenId();
        if (wxOpenId != null) {
            stmt.bindString(22, wxOpenId);
        }
        stmt.bindLong(23, entity.getMsgState() ? 1L: 0L);
 
        String msgSize = entity.getMsgSize();
        if (msgSize != null) {
            stmt.bindString(24, msgSize);
        }
        stmt.bindLong(25, entity.getAgencyLevel());
 
        List imageShare = entity.getImageShare();
        if (imageShare != null) {
            stmt.bindString(26, imageShareConverter.convertToDatabaseValue(imageShare));
        }
    }
    ...
    public UserInfoBean readEntity(Cursor cursor, int offset) {
        UserInfoBean entity = new UserInfoBean( //
            ...
            cursor.getShort(offset + 16) != 0, // firstLoginFlag
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // invitationCode
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // zhifubaoNum
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // wxName
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), // wxPhoto
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21), // wxOpenId
            cursor.getShort(offset + 22) != 0, // msgState
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23), // msgSize
            cursor.getInt(offset + 24), // agencyLevel
            cursor.isNull(offset + 25) ? null : imageShareConverter.convertToEntityProperty(cursor.getString(offset + 25)) // imageShare
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserInfoBean entity, int offset) {
        ...
        entity.setFirstLoginFlag(cursor.getShort(offset + 16) != 0);
        entity.setInvitationCode(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setZhifubaoNum(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setWxName(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        entity.setWxPhoto(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
        entity.setWxOpenId(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
        entity.setMsgState(cursor.getShort(offset + 22) != 0);
        entity.setMsgSize(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
        entity.setAgencyLevel(cursor.getInt(offset + 24));
        entity.setImageShare(cursor.isNull(offset + 25) ? null : imageShareConverter.convertToEntityProperty(cursor.getString(offset + 25)));
     }
