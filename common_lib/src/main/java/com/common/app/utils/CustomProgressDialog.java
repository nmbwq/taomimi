...
public class CustomProgressDialog extends Dialog {
    ...
    public static CustomProgressDialog createDialog(Context context, final boolean canCancle, @DrawableRes int loadImg,String txt){
        dialog = new CustomProgressDialog(context, R.style.CustomProgressDialog);
        dialog.setContentView(R.layout.progress_dialog_layout);

        ImageView iv_loading_logo = (ImageView) dialog.findViewById(R.id.iv_loading_logo);
        TextView tv_loading_desc = (TextView) dialog.findViewById(R.id.tv_loading_desc);
