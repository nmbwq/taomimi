...
public class SpannelTextViewSinge extends View {
    ...
    public SpannelTextViewSinge(Context context) {
        this(context, null);
    }

    public SpannelTextViewSinge(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpannelTextViewSinge(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mNewLine) {
            ...
            canvas.drawText(second, lp.leftMargin, (5f * scaleDenisty + 0.5f) + lp.topMargin + bitmap.getHeight() + (fontMetrics.descent - fontMetrics.ascent) / 2 + 10, paint);
        } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(width, (int) (34 * scaleDenisty + 2f));
    }
