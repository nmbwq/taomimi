...
public class HorizontalProgressBar extends View {
     ...
     * 文字背景颜色
     */
    private int wenzibgColor = 0x00000000;

    /**
     * 文字颜色
     */
    private int wenziColor = 0xFFC6B56B;

    /**
     * 进度条颜色
     */
    private int progressColor = 0xFFD9AC6A;
     ...
     */
    private void init() {
        progressPaintWidth = dp2px(20);
        tipHeight = dp2px(25);
        tipWidth = dp2px(44);
        tipPaintWidth = dp2px(1);
        triangleHeight = dp2px(3);
        roundRectRadius = dp2px(2);
        textPaintSize = dp2px(14);
        progressMarginTop = dp2px(15);
    ...
    private void initPaint() {
        ...
        tipPaint = getPaint(tipPaintWidth, wenzibgColor, Paint.Style.FILL);
