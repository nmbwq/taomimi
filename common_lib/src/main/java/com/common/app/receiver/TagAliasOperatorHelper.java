...
//                ExampleUtil.showToast(logs, context);
        ...
        if (mIAliasSearchLisenter != null){
            mIAliasSearchLisenter.onAliasSearch(jPushMessage);
        }
    }


    private IAliasSearchLisenter mIAliasSearchLisenter;
    public void setOnAliasSearchLisenter(IAliasSearchLisenter iAliasSearchLisenter){
        this.mIAliasSearchLisenter = iAliasSearchLisenter;
    }

    public interface IAliasSearchLisenter{
        void onAliasSearch(JPushMessage jPushMessage);
    }
