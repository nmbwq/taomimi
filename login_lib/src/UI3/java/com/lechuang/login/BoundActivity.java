...
public class BoundActivity extends BaseOtherActivity implements View.OnClickListener {
    ...
    private RelativeLayout mRlGuideLoginHint;
...
//        TranslateAnimation animation = new TranslateAnimation(0,0,0,dimension);
        animation.setDuration(1000);
        mRlGuideLoginHint.startAnimation(animation);
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.iv_common_close) {
            ...
            bound();
        }else if (id == R.id.ic_guide_hint_close){
            mRlGuideLoginHint.setVisibility(View.GONE);
...
//        allParam.put("name", name);
        ...
        NetWork.getInstance()
                ...
                .subscribe(new RxObserver<String>(BoundActivity.this) {
    ...
    private void bound() {
        ...
        NetWork.getInstance()
                ...
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new RxObserver<UsersBean>(BoundActivity.this) {
