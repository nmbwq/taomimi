...
public class FindPsdActivity extends BaseOtherActivity implements View.OnClickListener {
    ...
    protected void findViews() {
        ...
        mIvForgetClose = findViewById( R.id.iv_common_close );
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.iv_common_close) {//关闭当前页
            finish();
    ...
    private void updatePasswordSendVerifiCode(String phone) {
        ...
        NetWork.getInstance()
                ...
                .subscribe( new RxObserver<String>( FindPsdActivity.this ) {
        ...
        mTimerTask = new TimerTask() {
            ...
            public void run() {
                runOnUiThread( new Runnable() {
                    @Override
                    public void run() {
                        mTvForgetGetCode.setText( mCount + "秒" );
                        mCount--;
                        ...
                        if (mCount < 0) {
                            ...
                            mTimer = null;
                            mCount = 60;
                            mTvForgetGetCode.setText( "发送验证码" );
                            mTvForgetGetCode.setClickable( true );
                            mTvForgetGetCode.setEnabled( true );
                            mTvForgetGetCode.setTextColor( getResources().getColor( R.color.c_72FFFFFF ) );
                        } else {
