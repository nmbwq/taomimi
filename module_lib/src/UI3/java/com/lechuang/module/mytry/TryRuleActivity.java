...
@Route(path = ARouters.PATH_TRY_RULE)
public class TryRuleActivity extends BaseActivity implements View.OnClickListener, OnRefreshLoadMoreListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_try_rule;
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.et_bind_zfb_save){
            ...
            ShareUtils.umShare(TryRuleActivity.this, SHARE_MEDIA.WEIXIN, MyTryActivity.uriListUm, new UMShareListener() {
                @Override
            ...
            ShareUtils.umShare(TryRuleActivity.this, SHARE_MEDIA.WEIXIN_CIRCLE, MyTryActivity.uriListUm, new UMShareListener() {
                @Override
                public void onStart(SHARE_MEDIA share_media) {
                    Logger.e("-----", "onStart");
...
//            addShare(image,SHARE_MEDIA.WEIXIN_CIRCLE);
            ...
            ShareUtils.umShare(TryRuleActivity.this, SHARE_MEDIA.QQ, MyTryActivity.uriListUm, new UMShareListener() {
                @Override
                public void onStart(SHARE_MEDIA share_media) {
                    Logger.e("-----", "onStart");
                }
            ...
            ShareUtils.umShare(TryRuleActivity.this, SHARE_MEDIA.QZONE, MyTryActivity.uriListUm, new UMShareListener() {
                @Override
                public void onStart(SHARE_MEDIA share_media) {
                    Logger.e("-----", "onStart");
                }
    ...
    private void updataAlipay() {
        NetWork.getInstance()
                ...
                .subscribe(new RxObserver<TryRuleBean> (TryRuleActivity.this,true,false) {
