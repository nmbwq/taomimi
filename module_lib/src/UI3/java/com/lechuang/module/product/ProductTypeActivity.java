...
@Route(path = ARouters.PATH_PRODUCT_TYPE)
public class ProductTypeActivity extends BaseActivity implements OnRefreshLoadMoreListener, View.OnClickListener {
...
//        mNesProduct.setTopTabLayout(mShaiXuanProBottom,mShaiXuanProTop);
    ...
    private void getProductList(boolean isShowProgress) {
        ...
        NetWork.getInstance()
                ...
                .productShowAll_search_resultUrl(link,allParam)
...
//                    routerBean.i = mProductList.get(position).tbItemId;
                    ...
                    LinkRouterUtils.getInstance().setRouterBean(ProductTypeActivity.this, routerBean);
                }
            });
