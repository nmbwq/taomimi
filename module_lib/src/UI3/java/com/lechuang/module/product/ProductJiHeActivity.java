...
@Route(path = ARouters.PATH_PRODUCT_JIHE)
public class ProductJiHeActivity extends BaseActivity implements OnRefreshLoadMoreListener, View.OnClickListener {
...
//                    routerBean.i = mProductList.get(position).tbItemId;
                    ...
                    LinkRouterUtils.getInstance().setRouterBean(ProductJiHeActivity.this, routerBean);
                }
            });
