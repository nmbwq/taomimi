 ...
 * @describe:
 */
@Route(path = ARouters.PATH_FENSI_FS)
public class FenSiStraightFragment extends LazyBaseFragment implements OnRefreshLoadMoreListener {
...
//        int i = fenSiActivity;
    ...
    private void getProductList() {
        ...
        allParam.put ( "type","1" );
        if (!TextUtils.isEmpty ( bundle.getString("variety") )){
            allParam.put ( "variety",bundle.getString("variety") );
        }
        ...
        NetWork.getInstance ()
                ...
                .subscribe ( new RxObserver<FenSiBean> ( getActivity (), false, true ) {
                    ...
                    public void onSuccess(FenSiBean result) {
                        ...
                        setFansData(result.getFollowerList ());
                        /*//超级会员数量
                        Log.e ( "text超级会员",result.getSuperAgentCount ()+"位" );
                        Log.e ( "text普通会员",result.getAgentCount ()+"位" );
                        if (result.getSuperAgentCount ()>0){
                            fenSiActivity.getmTvVipNumber ().setText ( "超级会员："+result.getSuperAgentCount ()+"位" );
                        }else {
                            fenSiActivity.getmTvVipNumber ().setText ( "超级会员：0位" );
                        }

                        //普通会员数量
                        if (result.getAgentCount ()>0){
                            fenSiActivity.getmTvVipNumber ().setText ( "普通会员："+result.getAgentCount ()+"位" );
                        }else{
                            fenSiActivity.getmTvVipNumber ().setText ( "普通会员：0位" );
                        }*/
                    }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (!hidden){
            Log.e ( "text onresume","我显示了!!!!" );
            FenSiActivity fenSiActivity=(FenSiActivity) getActivity ();
            if (variety.equals ( "1" )){
                fenSiActivity.mTvCommonRight.setText ( "超级会员" );
            }if (variety.equals ( "0" )){
                fenSiActivity.mTvCommonRight.setText ( "普通会员" );
            }else {
                fenSiActivity.mTvCommonRight.setText ( "全部" );
            }
        }else {
            Log.e ( "text onresume","我因此了!!!!" );
        }
    }*/
