...
@Route(path = ARouters.PATH_Mine_ZERO_BUY_CONTENT)
public class ZeroBuyContentFragment extends LazyBaseFragment implements View.OnClickListener, OnRefreshLoadMoreListener {
    ...
    private void getProduct() {
        ...
        NetWork.getInstance()
                .setTag(Qurl.zeroBuyShowIngMy)
                .getApiService(ModuleApi.class)
                .zeroBuyShowIngMy(allParam)
    ...
    private void setProductAdapter(ArrayList<ShowInMyBean.ListBean> list) {
        ...
        if (mBaseQuickAdapter == null) {
            mBaseQuickAdapter = new BaseQuickAdapter<ShowInMyBean.ListBean, BaseViewHolder>(R.layout.layout_item_zerobuy_content, mListProcuct) {
                @Override
...
//                        }
                        ...
                        //中奖码
                        TextView tvZhongjiang=helper.getView( R.id.tv_zhongjiangma );
...
//                        TextView tvItemTryContentWillStartRewardTime = helper.getView(R.id.tv_item_try_content_will_start_reward_time);
                        ...
                        //需要人数
//                        if (item.obtype == 4 || item.obtype == 5) {
//                            tvItemTryContentNeedPersion.setVisibility(View.INVISIBLE);
//                            tvItemTryContentNeedPersion.setText("");
//                        } else {
                            tvItemTryContentNeedPersion.setVisibility(View.VISIBLE);
                            tvItemTryContentNeedPersion.setText("需" + item.needNum + "人次开奖");
//                        }

                        //开奖时间
                        if (!TextUtils.isEmpty(item.realEndTime) && (item.obtype == 4 || item.obtype == 5|| item.obtype == 6)) {
                        ...
                        //排名ranking
                        TextView tvRanking=helper.getView( R.id.tv_paiming );

                        //已中奖
                        if (item.obtype == 6){
                            tvItemTryContentRewardSelect.setText(" 必得商品 ");
                            tvItemTryContentRewardSelect.setTextColor( getResources().getColor( R.color.white ) );
                            tvItemTryContentRewardSelect.setBackground( getResources().getDrawable( R.drawable.bg_select_item_zerobuy_content_two ) );
                            tvItemTryContentRewardSelect.setVisibility(View.VISIBLE);
                            tvRanking.setText( "排名 1" );
                            tvZhongjiang.setText( "中奖码 "+item.winNum );
                            tvZhongjiang.setVisibility( View.VISIBLE );
                        }else if (item.obtype == 5) {
                            tvItemTryContentRewardSelect.setText(" 已中奖 ");
                            tvItemTryContentRewardSelect.setTextColor( getResources().getColor( R.color.c_FC5C20 ) );
                            tvItemTryContentRewardSelect.setBackground( getResources().getDrawable( R.drawable.bg_select_item_try_content ) );
                            tvZhongjiang.setText( "中奖码 "+item.winNum );
                            tvZhongjiang.setVisibility( View.VISIBLE );
                            tvItemTryContentRewardSelect.setVisibility(View.VISIBLE);
                            if (!TextUtils.isEmpty( item.ranking+"" )||item.ranking>0){
                                tvRanking.setVisibility( View.VISIBLE );
                                if (item.ranking>100){
                                    tvRanking.setText( "排名 100+" );
                                }else {
                                    tvRanking.setText( "排名 "+item.ranking );
                                }
                            }
                            ...
                            tvItemTryContentRewardSelect.setTextColor( getResources().getColor( R.color.white ) );
                            tvItemTryContentRewardSelect.setBackground( getResources().getDrawable( R.drawable.bg_select_item_zerobuy_content_one ) );
                            tvItemTryContentRewardSelect.setVisibility(View.VISIBLE);
                            tvZhongjiang.setText( "中奖码 "+item.winNum );
                            tvZhongjiang.setVisibility( View.VISIBLE );
                            if (!TextUtils.isEmpty( item.ranking+"" )||item.ranking>0){
                            ...
                            tvItemTryContentRewardSelect.setVisibility(View.INVISIBLE);
                            if (!TextUtils.isEmpty( item.ranking+"" )||item.ranking>0){
                                tvRanking.setVisibility( View.VISIBLE );
                                if (item.ranking>100){
                                    tvRanking.setText( "排名 100+" );
...
//                        }
                        ...
                        if (item.obtype == 3 && !TextUtils.isEmpty(item.preWinTime)) {
                            ...
                            tvItemTryContentWillStartReward.setText("预计开奖时间"+item.preWinTime);
                        } else {
                        ...
                        if (item.obtype == 2) {
                            tvItemTryContentJionState.setText("参与成功,待抽奖");
                        ...
                        //试用码
                        tvItemTryContentTryCode.setText("抽奖码:" + item.sum + "个 > ");
                ...
                public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                    try {
                        ...
                        if (id == R.id.tv_item_try_content_trycode) {//试用码
                            ...
                            //PATH_TRY_DETAILS
                            ARouter.getInstance().build(ARouters.PATH_ZERO_BUY_DETAILS)
