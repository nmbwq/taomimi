package java.com.lechuang.module.adress.SelectCityUtils;
...
import java.com.lechuang.module.adress.SelectCityUtils.wheelview.OnWheelChangedListener;
import java.com.lechuang.module.adress.SelectCityUtils.wheelview.OnWheelScrollListener;
import java.com.lechuang.module.adress.SelectCityUtils.wheelview.WheelView;
import java.com.lechuang.module.adress.SelectCityUtils.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    public ChangeAddressPopwindow(final Context context) {
        ...
        wvArea = view.findViewById( R.id.wv_address_area );
