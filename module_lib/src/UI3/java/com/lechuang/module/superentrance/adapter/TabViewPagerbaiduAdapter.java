...
public class TabViewPagerbaiduAdapter extends FragmentPagerAdapter{

    private Context mContext;
    private List<SuperBaihuoTabBean> mTabBeans;
    private List<Fragment> mTabFragment;
    public TabViewPagerbaiduAdapter(Context context, FragmentManager fm, List<SuperBaihuoTabBean> homeTabBeans, List<Fragment> tabFragment) {
        super(fm);
