package java.com.lechuang.module.order.widget;
...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor( ContextCompat.getColor(context, R.color.c_000000));
        //第二个paint
        nPaint = new Paint ( Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle( Style.FILL);
        nPaint.setTextAlign( Align.CENTER);
        nPaint.setColor( ContextCompat.getColor(context, R.color.c_666666));
    }
