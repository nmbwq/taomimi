...
public class LoopLayout extends RelativeLayout {
    ...
    private void initializeView() {
        ...
        indicatorLayout.setPadding(size / 2,0,size / 2,0);
...
//        animIndicatorLayout.setPadding(0,0,0,0);
    ...
    private void InitLittleRed() {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(size * 2, size);
